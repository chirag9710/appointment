...
class MyAppointmentState extends State<MyAppointment>with TickerProviderStateMixin
  ...
  Future<Uri> createDynamicLink(
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://ckevent.page.link',
      link: Uri.parse(
          'https://ckevent.page.link/appointment?summary=$title&description=$desc&startDate=$startDate&endDate=$endDate&senderEmail=$email&senderPhoto=$photoUrl&senderName=$senderName&timeZone=$timeZone'),
